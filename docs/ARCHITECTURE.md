...
- **Memory**: SQLite (conversations, agents, skills, A2A peers, MCP servers, skill files)
- **Filestore**: Disk-based skill file storage at `/data/filestore/skills/{skill_id}/{category}/`
